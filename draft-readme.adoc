...
----
This is the URL of your Tekton dashboard where you can create the webhook.
...
* Under "Target Pipeline Settings", select "Kabanero" namespace, "java-microprofile-build-push-pipeline" Pipeline, "kabanero-operator" Service Account, your Docker Registry URL in the form index.docker.io/<yourDockerUsername> 
