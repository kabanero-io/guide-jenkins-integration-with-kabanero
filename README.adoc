...
Kabanero provides a modern DevOps toolchain with pre-built pipelines using an open source project called Tekton. The Tekton project provides Kubernetes-style resources for declaring CI/CD-style pipelines. While it is advantagous to run both CI and CD using Tekton to leverage the power of Kubernetes to manage your toolchain, some may want to reuse Jenkins assets or skills.

With Kabanero, you can customize the deploy section of the pipeline to use Jenkins.
