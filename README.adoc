...
. **Verify deployment**:
Go to **Application** -> **Deployment** in your OpenShift portal to see the successful deployment. You can also see the URL of the running application by going to **Application** -> **Deployment** -> **Routes**.
