...
== Reference
* The following file is a sample Jenkinsfile that you can use to set up your initial Jenkinsfile for the guide. You'll need to adjust environment variables tagged 'envVar' that reflects your project:
----
